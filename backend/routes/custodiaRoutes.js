...
const { getChain, signAdvancedSignature, verifyIntegrity, verifyAdvancedSignature, verifyDoubleCheck, generateTraceabilityPDF, deleteHistory } = require('../controllers/custodiaController');
